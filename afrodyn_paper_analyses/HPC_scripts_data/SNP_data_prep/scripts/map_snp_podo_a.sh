...
path_to_ref="/home/helmstetter/podo_a/ref";
path_to_names="/home/helmstetter/data/hybpiper";
path_to_dir_out="/data3/projects/AFRODYN2/map_snp_podo_a_$JOB_ID";
...
done < $path_to_tmp/namelist.txt | parallel -j4
...
parallel -j 4 < parallel_readgroups.txt

parallel -j 4 < parallel_index.txt
#
parallel -j 4 < parallel_gvcf.txt
#
gatk CombineGVCFs -R joined_fasta_library.fasta -V I01_T17.g.vcf -V I01_T18.g.vcf -V I01_T19.g.vcf -V I01_T20.g.vcf -V I01_T21.g.vcf -V I01_T22.g.vcf -V I01_T23.g.vcf -V I01_T24.g.vcf -V I01_T25.g.vcf -V I01_T26.g.vcf -V I01_T27.g.vcf -V I01_T28.g.vcf -V I01_T29.g.vcf -V I01_T30.g.vcf -V I01_T31.g.vcf -V I01_T32.g.vcf -V I01_T33.g.vcf -V I01_T34.g.vcf -V I01_T35.g.vcf -V I01_T36.g.vcf -V I01_T37.g.vcf -V I01_T38.g.vcf -V I01_T39.g.vcf -V I01_T40.g.vcf -V I01_T41.g.vcf -V I01_T42.g.vcf -V I01_T43.g.vcf -V I01_T44.g.vcf -V I12_T67.g.vcf -V I12_T68.g.vcf -V I12_T69.g.vcf -V I12_T70.g.vcf -V I12_T71.g.vcf -V I12_T72.g.vcf -V I12_T76.g.vcf -V I12_T77.g.vcf -V I12_T78.g.vcf -O podo_a.g.vcf
gatk GenotypeGVCFs -R joined_fasta_library.fasta -V podo_a.g.vcf -G StandardAnnotation -new-qual -O podo_a.vcf 
