...
path_to_dir_out="/data3/projects/AFRODYN2/secapr_fries_$JOB_ID/";
...
scp nas2:/data/projects/afrodyn/RUN60_HISEQ/paired/trimtfiltcutRUN60_HISEQ-INDEX05-TAG-1* $path_to_tmp
...
mv $path_to_tmp/namelist_fries2.txt $path_to_tmp/namelist.txt
...
secapr assemble_reads --input ./cleaned_reads/ --output ./contigs/ --cores 4 --disable_stats
