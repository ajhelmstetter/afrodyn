...
path_to_dir_out="/data3/projects/AFRODYN2/map_snp_podo_b_$JOB_ID";
...
gatk GenotypeGVCFs -R joined_fasta_library.fasta -V podo_b.g.vcf -G StandardAnnotation -new-qual -O podo_b.vcf 
