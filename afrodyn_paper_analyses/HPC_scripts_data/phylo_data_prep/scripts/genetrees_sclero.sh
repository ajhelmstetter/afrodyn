...
path_to_dir_in="/data3/projects/AFRODYN2/align_sclero_out_1622157/helmstetter_1622157/gblocks";
path_to_dir_out="/home/helmstetter/genetrees_sclero_out_$JOB_ID/";
...
parallel -j 8 < raxml_parallel.txt
