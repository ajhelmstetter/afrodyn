...
path_to_dir_in="/home/helmstetter/hybpiper_pos_out_3335838/retrieved_supercontigs/oneline/header";
path_to_dir_out="/data3/projects/AFRODYN2/align_pos_$JOB_ID/";
