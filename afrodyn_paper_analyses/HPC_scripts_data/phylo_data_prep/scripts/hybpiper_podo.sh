...
path_to_dir_out="/home/helmstetter/hybpiper_podo_a_out_$JOB_ID/";
...
mv $path_to_tmp/namelist_podo_a_out.txt $path_to_tmp/namelist.txt
...
mkdir retrieved_dna
python retrieve_sequences.py palms.exons.final.fa . dna
mv *.FNA retrieved_dna/

mkdir retrieved_introns
python retrieve_sequences.py palms.exons.final.fa . intron
mv *.fasta retrieved_introns/

mkdir retrieved_supercontigs
python retrieve_sequences.py palms.exons.final.fa . supercontig
