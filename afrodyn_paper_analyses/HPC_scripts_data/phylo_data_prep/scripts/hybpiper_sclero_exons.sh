...
path_to_dir_out="/home/helmstetter/hybpiper_sclero_$JOB_ID/";
...
mv $path_to_tmp/namelist_sclero.txt $path_to_tmp/namelist.txt
...
mkdir retrieved_dna
python retrieve_sequences.py $path_to_tmp/palms.exons_split.final.fasta . dna
mv *.FNA retrieved_dna/

mkdir retrieved_introns
python retrieve_sequences.py $path_to_tmp/palms.exons_split.final.fasta . intron
mv *.fasta retrieved_introns/

mkdir retrieved_supercontigs
python retrieve_sequences.py $path_to_tmp/palms.exons_split.final.fasta . supercontig
