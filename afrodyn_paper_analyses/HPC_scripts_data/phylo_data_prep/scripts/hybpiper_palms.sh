...
path_to_dir_out="/home/helmstetter/hybpiper_palms_back_$JOB_ID/";
...
#Env0094: Phioenix rupicola: RUN 67 TAG16
#Env2160: Hyphaene thebaica: RUN 67 TAG21
#TS-S1318: Latania loddigesii: RUN67 TAG12

scp nas:/data2/projects/raphia/BORASSUS/RUN67/paired/trimtfiltcutRUN67-TAG-12_* $path_to_tmp
scp nas:/data2/projects/raphia/BORASSUS/RUN67/paired/trimtfiltcutRUN67-TAG-16_* $path_to_tmp
scp nas:/data2/projects/raphia/BORASSUS/RUN67/paired/trimtfiltcutRUN67-TAG-21_* $path_to_tmp

#R065: Raphia hookeri: R33 TAG36
scp nas:/data2/projects/raphia/RUN33/paired/trimtfiltcutR33-TAG-36* $path_to_tmp

#R162: Eremospatha quinquecostulata: R41 TAG 39
scp nas:/data2/projects/raphia/RUN41/paired/trimtfiltcutRUN41-TAG-39_* $path_to_tmp

#R135: Mauritella armata: R37 TAG 6
scp nas:/data2/projects/raphia/RUN37/paired/trimtfiltcutRUN37-TAG-6_* $path_to_tmp

#JCP_1776: Astrocaryum murumuru: RUN46 INDEX06 TAG39
#O013: Orania ravaka: RUN46 INDEX06 TAG32
#O001: Orania archboldiana: RUN46 INDEX06 TAG20
#O010: Orania_grandiflora: RUN46 INDEX06-TAG29

scp nas:/data2/projects/raphia/RUN46/paired/trimtfiltcutRUN46_INDEX06-TAG-20_* $path_to_tmp
scp nas:/data2/projects/raphia/RUN46/paired/trimtfiltcutRUN46_INDEX06-TAG-29_* $path_to_tmp
scp nas:/data2/projects/raphia/RUN46/paired/trimtfiltcutRUN46_INDEX06-TAG-32_* $path_to_tmp
scp nas:/data2/projects/raphia/RUN46/paired/trimtfiltcutRUN46_INDEX06-TAG-39_* $path_to_tmp

#P barateri
scp nas:/data2/projects/raphia/RUN49/paired/trimtfiltcutRUN49_INDEX01-TAG-13_* $path_to_tmp
scp nas:/data2/projects/raphia/RUN49/paired/trimtfiltcutRUN49_INDEX01-TAG-16_* $path_to_tmp
scp nas:/data2/projects/raphia/RUN49/paired/trimtfiltcutRUN49_INDEX01-TAG-53_* $path_to_tmp
...
#Sclerosperma mannii
scp nas:/data2/projects/raphia/RUN46/paired/trimtfiltcutRUN46_INDEX12-TAG-79_* $path_to_tmp
scp nas:/data2/projects/raphia/RUN46/paired/trimtfiltcutRUN46_INDEX11-TAG-85_* $path_to_tmp
scp nas:/data2/projects/raphia/RUN46/paired/trimtfiltcutRUN46_INDEX11-TAG-63_* $path_to_tmp


#sra plus Sebastian's samples
scp nas:/home/helmstetter/palms/sra/* $path_to_tmp
...
rename -v 'trimtfiltcutRUN41' 'R41' *
rename -v 'trimtfiltcutR33' 'R33' *
rename -v 'trimtfiltcutRUN37' 'R37' *
rename -v 'trimtfiltcutRUN67' 'R67' *
rename -v 'trimtfiltcutRUN46_INDEX' 'I' *
rename -v 'trimtfiltcutRUN49_INDEX' 'I' *
rename -v 'trimtfiltcutRUN67' 'R67' *
rename -v 'trimtfiltcutRun71' 'R71' *
...
mv $path_to_tmp/namelist_palms_back.txt $path_to_tmp/namelist.txt
mv $path_to_tmp/palms.exons.final.fasta  $path_to_tmp/palms.exons.final.fa 


#A loop that reads names of samples in namelist and runs reads_first.py part of the hybpiper pipeline
while read name; 
do python $path_to_tmp/reads_first.py -b $path_to_tmp/palms.exons.final.fa -r $path_to_tmp/"$name"_R1.fastq $path_to_tmp/"$name"_R2.fastq --prefix $path_to_tmp/$name --bwa
...
mkdir retrieved_dna
python retrieve_sequences.py $path_to_tmp/palms.exons.final.fa . dna
mv *.FNA retrieved_dna/

mkdir retrieved_introns
python retrieve_sequences.py $path_to_tmp/palms.exons.final.fa . intron
mv *.fasta retrieved_introns/

mkdir retrieved_supercontigs
python retrieve_sequences.py $path_to_tmp/palms.exons.final.fa . supercontig
