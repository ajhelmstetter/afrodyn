...
path_to_dir_out="/home/helmstetter/hybpiper_sclero_out_$JOB_ID/";
...
echo "copying fastqs";
scp nas:/data2/projects/raphia/RUN41/paired/trimtfiltcutRUN41-TAG-4* $path_to_tmp
scp nas:/data2/projects/raphia/RUN41/paired/trimtfiltcutRUN41-TAG-5* $path_to_tmp

scp nas:/data2/projects/raphia/RUN46/paired/trimtfiltcutRUN46_INDEX10* $path_to_tmp
scp nas:/data2/projects/raphia/RUN46/paired/trimtfiltcutRUN46_INDEX11* $path_to_tmp
scp nas:/data2/projects/raphia/RUN46/paired/trimtfiltcutRUN46_INDEX12* $path_to_tmp
...
mv $path_to_tmp/namelist_sclero_out.txt $path_to_tmp/namelist.txt
