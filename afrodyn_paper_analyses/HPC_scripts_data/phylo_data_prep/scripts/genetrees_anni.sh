...
path_to_dir_in="/data3/projects/AFRODYN2/secapr_anni_out_1594313/allele_alignments";
path_to_dir_out="/home/helmstetter/genetrees_anni_out_secapr_$JOB_ID/";
...
do
	...
	echo "raxmlHPC-PTHREADS -p 12345 -T 2 -m GTRGAMMA -# 10 -O -s $f -n $f" >> raxml_parallel.txt
done
