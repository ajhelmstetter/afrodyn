...
path_to_dir_out="/home/helmstetter/hybpiper_palms_back_exons_$JOB_ID/";
...
mv $path_to_tmp/palms.exons_split.final.fasta  $path_to_tmp/palms.exons.final.fa 
