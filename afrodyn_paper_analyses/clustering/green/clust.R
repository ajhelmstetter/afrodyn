...
library(pegas)
library(vcfR)
setwd("~/Dropbox/afrodyn_data/clustering/green/")
...
# read in VCF
###
vcf <- read.vcfR("green_filtered_maf.vcf",checkFile = T, convertNA = T) #read in all data
vcf
...
#save.image("~/Dropbox/afrodyn_data/stable_areas/data/green.Rdata")
...
#png("~/Dropbox/projects/AJH_AFRODYN/AFRODYN_shared/afrodyn_paper/review2_files/supp_figures/green_xval.png",height=750,width=750)
...
pdf("~/Dropbox/projects/AJH_AFRODYN/AFRODYN_shared/afrodyn_paper/review2_files/supp_figures/tess/green_barplot.pdf",height=4,width=12)
...
library(raster)
library(rworldmap)
png("~/Dropbox/projects/AJH_AFRODYN/AFRODYN_shared/afrodyn_paper/review2_files/supp_figures/tess/green_tess.png",height=750,width=750)
